...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-base-100 flex justify-between shadow-md p-5 dark:bg-gray-900 dark:text-gray-100 mb-10">
      <div className="navbar-start">
        ...
        <Link
          to="/"
          className="normal-case text-2xl font-medium text-transparent  bg-clip-text bg-gradient-to-r from-primary to-secondary "
        >
          Doctors Portal
        </Link>
      </div>
